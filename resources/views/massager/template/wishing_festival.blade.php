            ...
            <div class="col-md-7">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="template_id">Festival Name<span class="text-danger">(Required)</span></label>
                            <input type="text" placeholder="Enter Festival Name" name="params[]"
                                value="{{ old('params.0') }}" class="form-control">
                        </div>
