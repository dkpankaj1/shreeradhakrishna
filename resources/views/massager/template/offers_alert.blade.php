                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="template_id">Start Date <span
                                            class="text-danger">(Required)</span></label>
                                    <input type="date" name="params[]" value="{{old('params.0')}}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="template_id">End Date <span
                                            class="text-danger">(Required)</span></label>
                                    <input type="date" name="params[]" value="{{old('params.1')}}" class="form-control">
                                </div>
                            </div>
                        </div>
